...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 2111.0, 389.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1647.0, 929.0, 52.0, 22.0 ],
					"text" : "100000."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1551.0, 269.109857618808746, 355.0, 22.0 ],
					"text" : "append 2, append 3, append 4, append 8, append 12, append 16"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1225.5, 912.036605834960938, 71.0, 23.0 ],
					"text_width" : 46.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1732.0, 367.0, 85.0, 22.0 ],
					"text" : "r resetCounter"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1880.0, 590.57265716791153, 56.0, 22.0 ],
					"text" : "r~ drums"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1799.0, 590.57265716791153, 72.0, 22.0 ],
					"text" : "r~ distSynth"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 1876.0, 638.57265716791153, 81.0, 22.0 ],
					"text" : "mc.r~ synth 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 1764.0, 658.57265716791153, 60.0, 22.0 ],
					"text" : "mc.pack~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2153.0, 522.5, 56.0, 22.0 ],
					"text" : "10000"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1239.21443122625351, 702.0, 74.0, 22.0 ],
					"text" : "s~ distSynth"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1225.0, 756.0, 83.0, 22.0 ],
					"text" : "mc.s~ synth 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 1110.0, 756.0, 84.0, 22.0 ],
					"text" : "mc.unpack~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1213.0, 647.499930083751678, 100.21443122625351, 41.666662096977234 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"restore" : 					{
						...
						"filterCenterFreq" : [ 3608.39160839160877 ],
						"filterLfoDepth1" : [ 0.82 ],
						"filterLfoRate1" : [ 4.2 ],
						"filterResonance1" : [ 0.71 ],
						"kickGain" : [ 127 ],
						"mcSynthGain" : [ 128 ],
						"noteLength" : [ 949 ],
